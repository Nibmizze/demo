...
<html>
  <head>
	...
	<script type="text/javascript">
	 $(function(){
	    $("tr:eq(0)").css("background-color","#efefef"); //标题的样式
		$("tr:gt(0):even").css("background-color","white"); //奇数行的样式
		$("tr:gt(0):odd").css("background-color","#d1eeee"); //偶数行的样式
  ...
  <body>
    <div style="height: 35px;background-color:#efefef;">
	    <div id="cho">
	    <button id="fun" class="layui-btn layui-btn-mini layui-btn-normal">筛选</button> 
    ...
    <center>
    <div id="dinfo" style="display: none;padding-top: 10px;">
		<form id ="show" action="${pageContext.request.contextPath}/merchantController/showAll.do" method="post">
 			...
 			<div class="layui-inline">
  			 ...
  			 交易名称：
  			<select name="trans_name" lay-verify="required">
			...
			<select name="state" lay-verify="required">
  			...
  			卡信息：
  			<select name="dcflag" lay-verify="required">
    ...
    <c:choose>
    	...
    	<div style="margin-top: 20px;margin-left:15px;margin-right:15px">
    		<center style="overflow:auto;">
      		<table cellpadding="0" cellspacing="0" border="1px" bordercolor="#efefef" width="1750px">
      			<tr>
        			<th>交易日期</th>
        			<th>清算日期</th>
        			<th>导入日期</th>     															 						
	...
	<div id="info" style="display: none;">
		<form action="merchantController/outputExcel.do" method="post" onsubmit="return checkOut()">
			<div id="form">
   				<span>请输入导出文件名：</span><br>
   				<input type="text" name="export_file" placeholder="例：交易表-20170228" id="export_file">
   ...
   <div id="inputInfo" style="display: none;">
        	<form id ="upfile" action="${pageContext.request.contextPath}/merchantController/inputExcel.do" method="post" enctype="multipart/form-data">
          		<div class="dialogTop">
			  	<table width="400px" style="margin-top:50px;" border="0">
			  	<tr>
			          <td style="text-align: right;">请输入结算日期：</td>
			          <td>
			          	<div class="layui-inline">
						 <input name="data_date" class="layui-input" id="time" placeholder="结算日期" onclick="layui.laydate({elem: this, istime: true, format: 'YYYYMMDD'})">
				    	</div>
			          </td>
		          	</tr>
		          	<tr><td>&nbsp;</td></tr>
