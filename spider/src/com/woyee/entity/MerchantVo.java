...
public class MerchantVo {
	...
	public MerchantVo(String ins_rcv, String ins_snd, String traceno, String tdate, String ttime, String card_no,
			...
			String orderno, String trans_name, String dcflag, String file_name, String sdate, String edate,
			int spage, int epage, String state) {
		super();
	...
	public String toString() {
		return "MerchantVo [ins_rcv=" + ins_rcv + ", ins_snd=" + ins_snd + ", traceno=" + traceno + ", tdate=" + tdate
				...
				+ dcflag + ", file_name=" + file_name + ", sdate=" + sdate + ", edate=" + edate + ", spage=" + spage
				+ ", epage=" + epage + ", state=" + state + "]";
	}
